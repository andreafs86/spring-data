...
public class RelatorioFuncionarioDinamico {
	...
	public void inicial(Scanner scanner) {
		System.out.println("Favor digite um nome");
		...
		System.out.println("Favor digite um cpf");
		...
		System.out.println("Favor digite um salário");
		...
		System.out.println("Favor digite uma data de contratação");
